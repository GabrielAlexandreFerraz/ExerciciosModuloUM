...
arrayMusicas.forEach(item => {
    item.isGood = true
    return musicaGod.push(item)
  })
  
  musicaGod.forEach((item) => {
    var imprimirLista = document.createElement("li");
    imprimirLista.innerHTML += item.nome;
    divLista.appendChild(imprimirLista);
  });
