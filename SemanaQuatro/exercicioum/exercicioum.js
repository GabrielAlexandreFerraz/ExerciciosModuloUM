...
// 3- exampleVar - sendo uma variável não constante e de escopo global do tipo 
// string com a concatenação da seguinte 
...
var nomeDois = console.log("Olá meu nome é " + nome + " e tenho" + idade + "anos ")
